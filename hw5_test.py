...
class TestCard(unittest.TestCase):
    ...
    def test_q6(self):
        ...
        d1.deal_card()
        latter = len(d1.cards)
        self.assertEqual(former - latter, 1)
        #return X, Y    
    ...
    def test_q7(self):
        ...
        d1 = hw5_cards.Deck()
        c1 = d1.deal_card()
        cards_before = len(d1.cards)
        d1.replace_card(c1)
        cards_after = len(d1.cards)
        self.assertEqual(cards_after - cards_before, 1)
        #return X, Y
    ...
    def test_q8(self):
        ...
        d1 = hw5_cards.Deck()
        cards_before = len(d1.cards)
        c1 = random.choice(d1.cards)
        d1.replace_card(c1)
        cards_after = len(d1.cards)
        self.assertEqual(cards_after - cards_before, 0)
        #return X, Y  
